                ...
                <div class="card custom-card">
                    <div class="card-header">
                        <div class="custom-header-content">
                            <h3 class="mb-0">Edit Template: {{ $template->name }}</h3>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="form-text mt-2" id="template_key_status">
                                            ...
                                            This key is used to reference the template in your code
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control shadow-sm" id="description" name="description" rows="3"
                                            placeholder="Briefly describe the purpose of this template">{{ old('description', $template->description) }}</textarea>
                                    </div>
                                            ...
                                            @foreach ($channels as $channel)
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" name="channels[]"
                                                        ...
                                                        {{ in_array($channel, old('channels', $template->channels)) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control shadow-sm" id="content" name="content" rows="12" required
                                            placeholder="Write your template content here...">{{ old('content', $template->content) }}</textarea>
                                        <div class="form-text mt-2">
                                ...
                                <div id="variables-container" class="card bg-light border-0 p-3">
                                    @foreach (old('variables', $template->variables ?? []) as $name => $variable)
                                        <div class="row mb-2 variable-row">
                                            <div class="col-md-5">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control shadow-sm"
                                                        name="variables[][name]" value="{{ $name }}"
                                            ...
                                            <div class="col-md-1">
                                                <button type="button"
                                                    class="btn btn-outline-danger btn-sm w-100 remove-variable">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                        ...
                        function validateTemplateKey(key) {
                            ...
                            keyCheckTimeout = setTimeout(() => {
                                fetch(`{{ route('notigen.check-key') }}?key=${key}&id={{ $template->id }}`)
